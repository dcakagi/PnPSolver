...
from light_detector3 import LightDetector
...
if __name__ == '__main__':
    ...
    constellation_2 = {"18": [310,   0,    -200],
            ...
            "57": [-540,  690,  -200],
            "58": [-540,  -690, -200]}
    constellation_2.update(constellation_1)
    ...
    estimator_cv = PoseEstimator(constellation_2, pixels_width, pixels_height, focal_pixels_init, solver_type="opencv",use_guess=True)
    ...
    N = 100
    zs = np.arange(zs[-1],end_wrt_start[2],25)
    ...
    # for w in waypoints:
        ...
        if not flag:
            rot = airsim.to_quaternion(np.deg2rad(0),0,0)
        else:
        ...
        distances.append(abs(z_val/100))
        if switch:
            switch = False
    ...
    #         horizontalalignment='center', verticalalignment='top',
    #         )
    plt.savefig("60m_Descent_Simulated.png", dpi=500)
    plt.show()  